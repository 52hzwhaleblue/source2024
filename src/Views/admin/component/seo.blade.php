                                ...
                                <div class="tab-pane fade show {{ $k == 'vi' ? 'active' : '' }}"
                                    ...
                                    <div class="form-group last:!mb-0">
                                        <div class="label-seo">
                                            ...
                                            <strong
                                                    class="count-seo"><span>{{ !empty($seoDB) ? strlen(@$seoDB['title' . $k]??'') : 0 }}</span>/70
                                                ký tự</strong>
                                        </div>
                                    ...
                                    <div class="form-group last:!mb-0">
                                        <div class="label-seo">
                                            ...
                                            <strong
                                                    class="count-seo"><span>{{ !empty($seoDB) ? strlen(@$seoDB['keywords' . $k]??'') : 0 }}</span>/70
                                                ký tự</strong>
                                        </div>
                                    ...
                                    <div class="form-group last:!mb-0">
                                        <div class="label-seo">
                                            ...
                                            <strong
                                                    class="count-seo"><span>{{ !empty($seoDB) ? strlen(@$seoDB['description' . $k]??'') : 0 }}</span>/160
                                                ký tự</strong>
                                        </div>
