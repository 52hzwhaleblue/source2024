                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                ...
                                                <p
                                                    ...
                                                    Thông tin của quý khách đã được tiếp nhận. {{$optSetting['email']}} xin
                                                    gửi các tin tức và thông báo mới nhất từ chúng tôi.</p>
                                                <h3
                                        ...
                                        <tr>
                                            <td>
                                                <p
                                                    style="margin:4px 0;font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#444;line-height:18px;font-weight:normal">
                                                    {!! Func::decodeHtmlChars($params['content']) !!}</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
