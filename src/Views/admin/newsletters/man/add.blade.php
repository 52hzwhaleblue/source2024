            ...
            <div
                ...
                <div class="d-flex align-content-center flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary submit-check"><i class="far fa-save mr-2"></i>
                            Lưu</button>
 ...
 if (!empty($item['file_attach'])) { ?>
                                        <div class="file-uploaded mb-2">
                                            <a class="btn btn-sm bg-gradient-primary text-white d-inline-block align-middle rounded p-2"
                                                href="{{ upload('file', $item['file_attach']) }}"
                                                title="Download tập tin"><i class="fas fa-download mr-2"></i>Download
                                                tập tin</a>
                                        </div>
                                    <?php } ?>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control  text-sm" name="data[fullname]"
                                        id="name" placeholder="Họ Tên"
                                        value="{{ !empty(Flash::has('fullname')) ? Flash::get('fullname') : $item['fullname'] }}">
                                </div>
                                @endif
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control  text-sm" name="data[email]"
                                        id="name" placeholder="Email"
                                        value="{{ !empty(Flash::has('email')) ? Flash::get('email') : $item['email'] }}">
                                </div>
                                @endif
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control  text-sm" name="data[phone]"
                                        id="name" placeholder="Điện thoại"
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control  text-sm" name="data[address]"
                                        id="name" placeholder="Địa chỉ"
                                        value="{{ !empty(Flash::has('address')) ? Flash::get('address') : $item['address'] }}">
                                </div>
                                @endif
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" class="form-control  text-sm" name="data[subject]"
                                        id="name" placeholder="Chủ đề"
                                        value="{{ !empty(Flash::has('subject')) ? Flash::get('subject') : $item['subject'] }}">
                                </div>
                                @endif
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select id="confirm_status" name="data[confirm_status]"
                                        class="form-control select2">
                                        @foreach (config('type.newsletters.' . $type . '.confirm_status') as $key => $value)
                                        <option {{ @$item['confirm_status'] == $key ? 'selected' : '' }}
    ...
    <div
        ...
        <div class="d-flex align-content-center flex-wrap gap-2">
            ...
            <div class="d-flex gap-2">
                <button type="submit" class="btn btn-primary submit-check"><i class="far fa-save mr-2"></i>
                    Lưu</button>
                <button type="reset" class="btn btn-primary"><i class="fas fa-redo mr-2"></i> Làm
                    lại</button>
                <button class="btn btn-primary"><i class="fas fa-sign-out-alt mr-2"></i> Thoát</button>
