                                    ...
                                    <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1">
                                                ...
                                                <small
                                                    class="text-muted">{{ \NINA\Models\NewslettersModel::where('confirm_status', 1)->where('type', $key)->count() }}
                                                    tin mới</small>
                                            </div>
                                ...
                                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <small
                                                class="text-muted">{{ \NINA\Models\OrdersModel::where('order_status', 1)->count() }}
                                                đơn hàng mới</small>
                                        </div>
                                        <div class="flex-shrink-0 dropdown-notifications-actions">
