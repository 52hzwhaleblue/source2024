...
{
    protected $productionEndpoint = 'https://vtcpay.vn/bank-gateway';
    protected $testEndpoint = 'https://alpha1.vtcpay.vn/portalgateway';
    ...
    {
        $this->validate('currency','website_id', 'amount');
